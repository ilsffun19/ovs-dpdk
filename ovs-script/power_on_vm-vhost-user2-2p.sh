...
then
    ...
    taskset -c 11-13 /root/ovs-dpdk/qemu-2.12.1/x86_64-softmmu/qemu-system-x86_64 -m 4096 -smp 3,cores=3,threads=1,sockets=1 -cpu host -drive format=raw,file=$vm -boot c -enable-kvm -name $vm_name \
