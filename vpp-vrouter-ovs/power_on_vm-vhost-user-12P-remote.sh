...
then
    ...
    numactl -C 1-13 -m 0 /root/qemu-2.12.0/x86_64-softmmu/qemu-system-x86_64 -m 16G -smp 13,cores=13,threads=1,sockets=1 -cpu host -drive format=qcow2,file=$vm  -boot c -enable-kvm -name $vm_name \
