...
vm=/root/vm-images/ubuntu-16.04-vpp2.img
vm_name=VPP-VM2
vnc=2
echo "ssh 2024"
echo "vnc $vnc"
...
then
    ...
    echo "VM $vm started! VNC: $vnc, ssh port: 24"
    taskset -c 28-30,32  /root/ovs-dpdk/qemu-2.12.1/x86_64-softmmu/qemu-system-x86_64 -m 8G -smp 4,cores=4,threads=1,sockets=1 -cpu host -drive format=raw,file=$vm  -boot c -enable-kvm -name $vm_name \
